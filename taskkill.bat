...
TASKKILL.exe /F /IM "Filezilla.exe"
TASKKILL.exe /F /IM "wapttray.exe"
TASKKILL.exe /F /IM "Spotify.exe"
net stop "TeamViewer 10"
net stop "DYMO PnP Service"
net stop "WAPTService"
net stop "Veeam Endpoint Backup"
net stop "OpenVPN Access Client"
